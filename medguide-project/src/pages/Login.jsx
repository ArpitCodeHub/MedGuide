  ...
  return (
    <>
      ...
      <form className='mx-auto mt-20 px-10 py-5 rounded-lg max-w-[600px] h-auto shadow-2xl' onSubmit={handleSubmit}>
        <h1 className='text-3xl text-cyan-600 text-center font-bold text-'> Login </h1>
        <br /><br />
        <div className='mb-5'>
        ...
        <div className="mt-5 text-center" >
            <button className='bg-cyan-600 text-white text-xl px-3 py-2 rounded-md active:scale-90 border-none hover:bg-cyan-500' type="submit"> Login </button>
            <br /><br />
            <span className='text-black'>Don't have an account? </span><Link to="/signup" className='text-cyan-600 font-semibold'>Sign Up</Link>
        </div>
      </form>
    </>
  )
